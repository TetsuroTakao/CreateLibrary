...
namespace React.Sample.Webpack.CoreMvc.Controllers
{
	public class AccountController : Controller
    {
		...
		public void SignIn()
		{
			...
			history.TenantID = Environment.GetEnvironmentVariable("TenantID");
			//history.ClientId = "__APP CLIENT ID__";
			history.ClientId = Environment.GetEnvironmentVariable("ClientId");
			history.Redirect = new Uri("http://localhost:9457/home");
			history.GrantType = "implicit";// this is dummy for shared procedure.
